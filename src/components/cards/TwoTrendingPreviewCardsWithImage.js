...
const PrimaryLink = styled(PrimaryLinkBase)`
  ${tw`inline-flex items-center justify-center mt-8 text-lg xl:justify-start`}
  svg {
    ${tw`w-5 h-5 ml-2`}
  }
`
...
const CardMeta = styled.div`
  ${tw`flex flex-row flex-wrap justify-between text-xs font-semibold tracking-wide text-gray-600 uppercase sm:items-center`}
`
