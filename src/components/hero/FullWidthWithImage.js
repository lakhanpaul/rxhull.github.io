...
const StyledNavLink = tw(NavLinkBase)`
  sm:text-sm sm:mx-6
`
...
const RightColumn = styled.div`
  ...
  ${tw`bg-green-500 bg-center bg-cover xl:ml-24 h-96 lg:h-auto lg:w-1/2 lg:flex-1`}
`
...
const Actions = styled.div`
  ${tw`mb-8 lg:mb-0`}
  .action {
    ${tw`inline-block w-full py-4 font-semibold tracking-wide text-center transition duration-300 rounded sm:w-48 hocus:outline-none focus:shadow-outline`}
  }
  .primaryAction {
    ${tw`text-gray-100 bg-primary-500 hover:bg-primary-700`}
  }
  .secondaryAction {
    ${tw`mt-4 text-gray-700 bg-gray-300 sm:mt-0 sm:ml-4 hover:bg-gray-400 hover:text-gray-800`}
  }
`
