...
import { SectionHeading as HeadingTitle, Subheading } from '../misc/Headings.js'
import { PrimaryButton as PrimaryButtonBase } from '../misc/Buttons.js'
import UserIcon from 'feather-icons/dist/icons/user.svg'
import TagIcon from 'feather-icons/dist/icons/tag.svg'
...
const Image = styled.div((props) => [
  ...
  tw`bg-center bg-cover rounded rounded-b-none h-80 lg:h-64`,
])
