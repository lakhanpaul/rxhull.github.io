...
const TextColumn = styled(Column)((props) => [
  tw`mt-16 md:w-7/12 xl:w-6/12 md:mt-0`,
  props.textOnLeft
...
const ControlButton = styled.button`
  ${tw`p-4 mx-3 transition duration-300 bg-gray-200 rounded-full hover:bg-gray-300 text-primary-500 hover:text-primary-700 focus:outline-none focus:shadow-outline`}
  svg {
    ${tw`w-4 h-4 stroke-3`}
  }
`
