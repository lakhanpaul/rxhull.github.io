...
const TestimonialsSlider = styled(Slider)`
  ${tw`flex max-w-xs mx-auto mt-16 text-left text-gray-900 bg-gray-100 rounded-lg sm:max-w-xl lg:max-w-4xl`}
  .slick-track {
    ${tw`flex!`}
  }
  .slick-slide {
...
const ControlButton = styled.button`
  ${tw`mt-4 ml-4 text-gray-600 transition-colors duration-300 hover:text-primary-700 focus:outline-none first:ml-0 sm:first:ml-4 sm:mt-0`}
  .icon {
    ${tw`w-6 fill-current`}
  }
`
