...
const FormStyle = tw.form`mt-8 md:mt-10 text-sm flex flex-col lg:flex-row`
      ...
      <TwoColumn>
        ...
        <TextColumn textOnLeft={textOnLeft}>
          <TextContent>
            ...
            <FormStyle action={formAction} method={formMethod}>
              <Input
                type='email'
                name='email'
              ...
              <Form className='w-full h-full'>
                <div className='flex flex-col items-center justify-center w-full bg-red-500 h-96'>
                  <TextInput
                    id='test'
                    placeholder='testing'
                    validate='numeric'
