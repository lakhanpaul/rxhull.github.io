...
import MarketingProgramPage from './pages/MarketingProgram'
import TechnologyProgramPage from './pages/TechnologyProgram.js'
import OpportunityFinderPage from './pages/OpportunityFinder.js'
...
import MarketingProgramSignUp from './pages/MarketingProgramSignUp.js'
import OpportunitySubmission from './pages/OpportunitySubmission.js'
...
export const components = {
  ...
  innerPages: {
    ...
    MarketingProgramPage: {
      component: MarketingProgramPage,
      url: `/components/innerPages/MarketingProgramPage`,
      imageSrc: PrivacyPolicyPageImageSrc,
    },
    TechnologyProgramPage: {
      component: TechnologyProgramPage,
      url: `/components/innerPages/TechnologyProgram`,
      imageSrc: PrivacyPolicyPageImageSrc,
    },
    OpportunityFinderPage: {
      component: OpportunityFinderPage,
  ...
  blocks: {
    ...
    Form: {
      ...
      elements: {
        ...
        MarketingProgramSignUp: {
          name: 'Marketing Program Sign Up built on Two Column Contact Us - Full Form',
          component: MarketingProgramSignUp,
          url: '/components/blocks/Form/MarketingProgramSignUp',
        },
        OpportunitySubmission: {
          name: 'Opportunity Submission built on Two Column Contact Us - Full Form',
          component: OpportunitySubmission,
          url: '/components/blocks/Form/OpportunitySubmission',
        },
      },
    },
